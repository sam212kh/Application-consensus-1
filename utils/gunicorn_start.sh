...
NAME="consensus"                                  # Name of the application
ROOTDIR=/opt/webapps
...
DJANGO_SETTINGS_MODULE=consensus.settings.main             # which settings file should Django use
DJANGO_WSGI_MODULE=consensus.wsgi                     # WSGI module name
...
export PYTHONPATH=${DJANGODIR}/consensus:${PYTHONPATH}
