        ...
        >
          ...
          <div class="info">
            <div class="left">
              ...
              <h6>Scored : {{ season.applicatonScored || 0 }}</h6>
            </div>
...
export default {
  ...
  methods: {
    ...
    fragmentationApplication: function(applications) {
      ...
      self.season.applicatonScored = self.season.applicatonScored || 0;
      applications.forEach(function(application) {
        if (application.score > 0) {
          self.season.applicatonScored++;
        }
      });
      // TODO: check which application is new(create_date equals today)
      // TODO: check which application enrolled
    }
  }
};
</script>
