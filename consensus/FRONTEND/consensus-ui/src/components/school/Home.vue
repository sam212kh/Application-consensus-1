    ...
    <div class="row row-no-padding">
      <div class="col">
        ...
        >
          ...
          <template slot="collapse" scope="props">
            <div class="table-button-container">
              <button
                class="btn btn-info btn-sm"
                @click="collapse(props.rowData);"
              >
              ...
              <button
                class="btn btn-info btn-sm"
                @click="goToSchool(props.rowData);"
              >
...
export default {
  ...
  methods: {
    ...
    goToSchool: function(school){
      this.$router.push({ name: "school.view", params: { id: school.id }  });
    },
